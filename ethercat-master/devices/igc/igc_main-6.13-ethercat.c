...
#include "igc-6.13-ethercat.h"
#include "igc_hw-6.13-ethercat.h"
#include "igc_tsn-6.13-ethercat.h"
#include "igc_xdp-6.13-ethercat.h"
	...
	while (likely(total_packets < budget)) {
		...
		if (IS_ERR(skb)) {
			...
			if (skb)
				...
				skb = igc_construct_skb(rx_ring, rx_buffer, ( struct igc_xdp_buff *)&ctx.xdp);

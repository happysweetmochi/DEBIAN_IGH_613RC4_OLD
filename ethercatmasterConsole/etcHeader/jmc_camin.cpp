...
////int JMC_CamIn::setParam(axis_ref *axis,double vel,double acc,double dec,double jerk)
////{
...
////    return 0;
////}
//void JMC_CamIn::call(QString master_name , QString slave_name , int camID)
//{
//    //call( axis_name, Execute, fVel, fAcc, fDec, fJerk);
//    axis_ref *master = ec::get_axis(master_name);
//    axis_ref *slave = ec::get_axis(slave_name);
//    if (master == nullptr || slave == nullptr){
//        out_error(2);
//        return;
//    }
//    call(master,slave,xExecute,pos,vel,acc,dec,jerk);
//}
////void JMC_CamIn::call(axis_ref *axis)
////{
...
//void JMC_CamIn::call(axis_ref *axis,bool xExecute,double vel,double acc,double dec,double jerk)
//{
